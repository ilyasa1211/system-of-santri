...
router.get("/", middleware.accountIs(role_1.ROLES.ADMIN, role_1.ROLES.MANAGER), WorkController.index);
router.post("/", middleware.accountIs(role_1.ROLES.ADMIN, role_1.ROLES.MANAGER, role_1.ROLES.SANTRI), WorkController.insert);
