...
export default class WorkService {
    ...
    public async createNewWork(payload: any, user: TAccount) {
    ...
    public async updateWorkById(id: string, payload: any, user: TAccount) {
        const work = await this.workRepository.findById(id);
    ...
    public async deleteWorkById(id: string, user: TAccount) {
