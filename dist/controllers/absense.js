			...
			accounts === null || accounts === void 0
				...
				: accounts.forEach((account) => {
						account.absenses.forEach((absense) => {
							...
							account.absense.months[traits_1.MONTHS[Number(month) - 1]][
								Number(day) - 1
	...
	return __awaiter(this, void 0, void 0, function* () {
		try {
			...
			const account = yield account_1.Account.findById(id)
				...
				.populate("absense", ["months", "year"], undefined, {
					year: currentYear,
				})
				.exec();
			if (!account) {
			...
			(_a = account.absenses) === null || _a === void 0
				? void 0
				: _a.forEach((absense) => {
						const [day, month, year, status] = absense.split("/");
						if (year !== currentYear.toString()) return;
		...
		try {
			...
			if (!token) {
				throw new errors_1.BadRequestError(
					response_1.ResponseMessage.EMPTY_TOKEN,
				);
			}
