...
exports.show = exports.destroy = exports.update = exports.insert = exports.index = void 0;
...
function show(request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const note = yield note_model_1.default.findById(request.params.id);
...
function insert(request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const learningExists = yield note_model_1.default.exists({ _id: id });
            if (!learningExists) {
            ...
            const notes = yield note_model_1.default.create(request.body);
...
function update(request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const notes = yield note_model_1.default.findByIdAndUpdate(request.params.id, request.body);
            return response.status(http_status_codes_1.StatusCodes.OK).json({
...
function destroy(request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const notes = yield note_model_1.default.findByIdAndDelete(request.params.id);
            return response.status(http_status_codes_1.StatusCodes.OK).json({
